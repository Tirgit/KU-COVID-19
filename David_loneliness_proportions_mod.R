...
d_pop$severe_lonely[d_pop$q16_sum >= 5 & d_pop$q16_sum <= 6] <- 1
...
d_fam$severe_lonely[d_fam$q16_sum >= 5 & d_fam$q16_sum <= 6] <- 1
...
d_eld$severe_lonely[d_eld$q16_sum >= 5 & d_eld$q16_sum <= 6] <- 1
...
p <- ggplot(data = res1, aes(y = percent_lon, x = agecat)) +
  ...
  ggtitle("Percentage reporting moderate loneliness (Mar - May 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)


pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Mar_May_2020.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res1, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (mar - maj 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)
...
pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Mar_May_2020_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res2, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Percentage reporting moderate loneliness (Sep - Oct 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Sep_Oct_2020.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res2, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (sep - okt 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Sep_Oct_2020_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res3, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Percentage reporting moderate loneliness (Nov - Dec 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Nov_Dec_2020.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res3, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (nov - dec 2020)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Nov_Dec_2020_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res4, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Percentage reporting moderate loneliness (Jan - Feb 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Jan_Feb_2021.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res4, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (jan - feb 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Jan_Feb_2021_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res5, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Percentage reporting moderate loneliness (Mar - Apr 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Mar_Apr_2021.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res5, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (mar - apr 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_Mar_Apr_2021_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res6, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Percentage reporting moderate loneliness (May - Jun 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_May_Jun_2021.pdf", width = 8, height = 6)
p
dev.off()
...
p <- ggplot(data = res6, aes(y = percent_lon, x = agecat)) +
  ...
  scale_y_continuous(limits = c(0,65), expand = c(0, 0)) +
  geom_hline(yintercept=0) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed (maj - jun 2021)") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none") + 
  geom_text(aes(y = 3, label=samplesize), vjust = -2.5) +
  geom_text(aes(y = percent_lon + 2, label=perctext), vjust = -2.5)

pdf("C:/Users/vrw657/Documents/Projects/Corona_SJPH/DK_plots/moderate_loneliness_May_Jun_2021_DAN.pdf", width = 8, height = 6)
p
dev.off()
...
# plot proportion moderate lonely
res <- d_pop_subset %>%
  group_by(date) %>%
  summarise(n = n(),
            percent_lon = 100*(sum(severe_lonely == 1)/n),
...
p <- ggplot(data = res, aes(y = percent_lon, x = date)) +
  ...
  geom_hline(yintercept=0) +
  #expand_limits(x = as.Date(c("2020-03-03", "2020-12-30"))) +
  ggtitle("Procentdel, der rapporterer moderat ensomhed i befolkningen") +
  #theme(plot.title = element_text(size = 12, face = "bold",hjust = 0.5)) +
  theme(legend.position = "none")
